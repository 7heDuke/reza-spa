<template>
    <div>
        <form @submit.prevent="submit_form">
            ...
            <input type="submit" class="btn btn-primary" :value="form_submitting ? 'Updating post...' : 'Update'" :disabled="form_submitting" >
        </form>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            submit_form() {
                ...
                .then(response => {
                    this.$swal({icon: 'success', title: 'Post successfully updated'});
                    this.$router.push('/');
